...
public class QuanLyNguoihoc extends javax.swing.JInternalFrame {
    ...
    public boolean isExists() {
        return nguoiHocDao.selectById(txtMaNguoiHoc.getText()) != null;
    }
    
    public boolean isStudent() {
        return !new HocVienDAO().selectByMaNguoiHoc(txtMaNguoiHoc.getText()).isEmpty();
    }
