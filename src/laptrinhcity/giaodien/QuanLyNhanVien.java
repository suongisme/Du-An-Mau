...
public class QuanLyNhanVien extends javax.swing.JInternalFrame {
    ...
    private void delete() {
        try {
            ...
            if (MsgBox.confirm(this, "Bạn có chắc chắn không?")) {
                nhanVienDAO.delete(txtMaNhanVien.getText());
    ...
    public boolean isError() {
        ...
        if (isExists()) {
            MsgBox.alert(this, "Nhân viên này đã tồn tại");
            return true;
        }
    ...
    public boolean isExists() {
        return nhanVienDAO.selectById(txtMaNhanVien.getText()) != null;
    }
    ...
    public boolean allowDelete() {
        ...
        if (hasStudent()) {
            MsgBox.alert(this, "Nhân viên này đã tạo người học");
            return false;
        }
        return true;
    }
    ...
    public boolean isYourself() {
        return Auth.user.getMaNhanVien().equals(txtMaNhanVien.getText());
    }
    
    public boolean hasCourse() {
        return !new KhoaHocDAO().selectByMaNhanVien(txtMaNhanVien.getText()).isEmpty();
    }
    
    public boolean hasStudent() {
        return !new NguoiHocDAO().selectByMaNhanVien(txtMaNhanVien.getText()).isEmpty();
    }
