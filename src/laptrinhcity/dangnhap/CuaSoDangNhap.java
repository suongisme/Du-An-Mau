 ...
 */
package laptrinhcity.dangnhap;

import java.awt.Color;
import laptrinhcity.DAO.NhanVienDAO;
import laptrinhcity.manhinhchinh.ManChinh;
...
public class CuaSoDangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/laptrinhcity/hinh/language_english.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/laptrinhcity/hinh/login.png"))); // NOI18N
...
//        </editor-fold>
    ...
    private boolean isEmpty() {
        if (txtTenDangNhap.getText().length() <= 0 || String.valueOf(txtMatKhau.getPassword()).length() <= 0) {
            MsgBox.alert(this, "Tên đăng nhập và mật khẩu không được trống!");
            return true;
        }
        return false;
    }
